...
Chronic Pain has ZERO coverage — no source classifies for it, confirmed
live 2026-08-27. Not fixed here; flagged as a real gap needing a new
source (same pattern as the 4 neurodivergence sources being added for
their own coverage gap, migration 0160).
