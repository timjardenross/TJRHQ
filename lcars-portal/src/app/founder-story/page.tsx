...
const storyBlocks = [
  ...
  `For more than 20 years, I have lived with chronic spinal pain, surgery, setbacks, anxiety, and the ongoing work of rebuilding health, confidence and identity. There was no single breakthrough or quick fix. It has been a long process of learning what genuinely helps, letting go of what does not, and finding practical ways to keep moving forward when progress is slow.`,
      ...
      <aside className="space-y-6">
        ...
        <section className="rounded-[32px] border border-[#d9e1f0] bg-[#1f2f5f] p-6 text-white">
          ...
          <p className="mt-4 text-base leading-7 text-[#eef3ff]">
            No hype. No unrealistic promises. Just practical tools, honest conversations, and steady progress.
          </p>
        </section>
      </aside>
    </PublicShell>
