...
// Standalone brand shell for the Knowledge Workbench — same wb- design
// system and layout as the Intelligence Workbench Shell, branded for Knowledge.
// Deliberately no LCARS app chrome (this route lives outside the (app) group),
// matching the intelligence-workbench / comms-workbench precedent.
    ...
    <div className="min-h-[100dvh] bg-wb-bg font-sans text-wb-ink antialiased">
      ...
      <main id="wb-main" className="mx-auto max-w-4xl px-6 py-8">
        ...
        <p className="mt-8 text-center text-[11px] text-wb-ink2">
          USS TJR · Knowledge · Memory · Library · Organisational decisions and personal documents
        </p>
      </main>
    </div>
  );
