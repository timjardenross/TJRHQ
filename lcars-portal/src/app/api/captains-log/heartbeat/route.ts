 ...
 * own heartbeat directly (see core-events.ts's module docstring for the
 * same core_events RLS pattern). This route is the RLS-safe side channel
 * the client calls, and only calls, after its own upsert has already
 * succeeded.
 *
