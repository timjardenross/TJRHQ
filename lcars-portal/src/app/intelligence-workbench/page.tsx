    ...
    >
      ...
      {domain === 'operational' && operationalData ? (
        <>
          ...
          {/* Operational hot incidents — fresh feed from daily sync, prioritized per Review Board finding */}
          ...
          {/* Operational briefs — fortnightly stale queue, deprioritized per Review Board finding */}
