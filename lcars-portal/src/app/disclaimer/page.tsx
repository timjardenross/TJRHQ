...
const disclaimers = [
  {
    ...
    body: `The content on this website is provided for general educational and coaching-focused purposes. It is intended to support reflection, practical resilience, and informed conversations. It is not clinical treatment, therapy, diagnosis, or medical advice.`,
  },
  {
  ...
  },
  {
    ...
    body: `If this website discusses stress, pain, rebuilding, or self-management concepts, that information remains general in nature. Decisions about symptoms, treatment, medication, diagnosis, mental health concerns, or urgent care should be made with an appropriate clinician.`,
  },
  {
...
export default function DisclaimerPage() {
  return (
    <PublicShell
      ...
      intro="This page clarifies the scope of the public TJR Mind & Body website and the limits of the information provided here."
    >
      ...
      <aside className="space-y-6">
        <section className="rounded-[32px] border border-[#d9e1f0] bg-[#eaf0fb] p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-[#4b5c78]">
            TJR Mind &amp; Body supports education and coaching conversations. It does not pretend to replace clinicians or emergency services.
          </p>
        </section>
