...
// Standalone brand shell for the Advisory Workbench — same wb- design system
// and layout as the Human Systems / Intelligence Workbench Shells, branded for
// Advisory. Deliberately no LCARS app chrome (this route lives outside the
// (app) group), matching the workbench precedent.
    ...
    <div className="min-h-[100dvh] bg-wb-bg font-sans text-wb-ink antialiased">
      ...
      <header className="border-b border-wb-line bg-wb-bg/80 backdrop-blur">
        <div className="mx-auto flex max-w-4xl items-center gap-3 px-6 py-4">
          <Link
            ...
            aria-label="Advisory Workbench home"
          >
            TJR
          </Link>
      ...
      <main id="wb-main" className="mx-auto max-w-4xl px-6 py-8">
        ...
        <p className="mt-8 text-center text-[11px] text-wb-ink2">
          USS TJR · Advisory · Consult · Board · Perspectives · Advisory only — the Captain decides
        </p>
      </main>
    </div>
  );
