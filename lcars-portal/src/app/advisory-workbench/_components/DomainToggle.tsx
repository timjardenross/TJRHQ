...
/** Three-way domain switch. Mirrors the Human Systems / Intelligence Workbench
...
export function DomainToggle({ domain, onChange }: { domain: Domain; onChange: (d: Domain) => void }) {
  return (
    <div role="tablist" aria-label="Advisory domain" className="flex gap-1 rounded-md border border-wb-line bg-wb-surface px-1.5 py-1">
      {DOMAINS.map((d) => {
