...
/** Two-way domain switch (Brief | Domains). Mirrors the Advisory / Human
 *  Systems Workbench toggle; keyboard navigable with role=tablist semantics
 *  for WCAG 2.1 AA. */
export function DomainToggle({ domain, onChange }: { domain: Domain; onChange: (d: Domain) => void }) {
  return (
    <div
      role="tablist"
      aria-label="Captain’s Brief view"
