...
- `app.py` - Slack event entry point. Runtime dispatch order is GitHub issue generation, mission registry, specialist registry, repository awareness, collaboration, then normal Commander response.
...
- `collaboration_engine.py` - Multi-specialist collaboration path.
