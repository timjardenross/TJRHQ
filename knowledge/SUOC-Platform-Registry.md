...
|---|---|---|---|---|---|---|---|---|---|---|
| Governance | Fragmented, consolidation continuing | L2 | 65% | Chief Engineer / Number One | Active (fragmented) | Medium | Y·Y·~·Y | Architectural Debt | Fix Later | ADR-registry consolidation: canonical dir now holds 9 filed ADRs (ADR-003/004/013/020/022/024/027/030/031, 3 of them explicitly low-confidence reconstructions per USS-TJR-MSN-0369) out of the ~9 real-cited numbers this pass covered; ~23 other bare ADR-number citations remain unverified against the canonical directory |
...
| CI/CD & Supply-Chain Hygiene | USS-TJR-MSN-0369: bandit Medium backlog triaged to 0 (180 findings fixed/suppressed with dated reasons), CI's bandit step flipped to blocking. Ruff's 3,420-finding auto-fixable subset landed as an isolated PR; ~3,395 manual-judgment findings remain, CI's ruff-check step stays informational. All 11 open Dependabot PRs triaged (7 merged-and-verified, 4 closed/deferred with specific written reasons). | L2 | 65% | Chief Engineer | Active (bandit gate) / Degraded (ruff gate, informational by necessity — real backlog remaining, not neglect) | Low | Y·Y·Y·Y (bandit) / Y·Y·~·N (ruff blocking gate) | Architectural Debt (ruff manual-judgment backlog) | Fix Later | Triage the remaining ~3,395 ruff findings (file-by-file or rule-by-rule) to flip CI's ruff-check step to blocking; re-verify #157 (supabase) before its deferred upgrade; revisit lcars-portal deps (#160/#162/#168) once Vercel deploy-rate-limit clears |
